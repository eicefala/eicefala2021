...
\end{docspec}
If the dimension is positive it will push the sidenote down the page\index{page}; if the
dimension is negative, it will move the sidenote up the page\index{page}.
...
increased slightly.\cite[.32]{Bringhurst2005} The \doccmddef{allcaps} command has proper letterspacing for
...
documentation.\cite[p.33]{pkg-geometry}

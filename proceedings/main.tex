...
% https://tex.stackexchange.com/questions/175788/how-to-manage-large-sidenotes-in-tufte-handout-class
% manage large sidenotes in tufte-handout class
...
\includepdf[pages=-]{imgs/ficha.pdf}
...
\epigraphhead[450]{If we are uncritical we shall always find what we want: we shall look for, and find, confirmations, and we shall look away from, and not see, whatever might be dangerous to our pet theories.\par\hfill\textsc{Karl Popper}}
% The unity of method [chapter 29]. in: The poverty of historicism. Beacon Press, Boston, Mass1957 

% Pierrehumbert, Janet, Beckman, Mary and Ladd, Robert. 'Conceptual Foundations of Phonology as a Laboratory Science'. In Burton-Roberts, Noel; Carr, Philip, and Docherty, Gerard (eds.). Phonological Knowledge: Conceptual and Empirical Issues. Oxford: Oxford University Press, 2000.
% "Methodological advances can be just as important as theoretical ones in the progress of science. Established sciences use diverse methods. (...) theories which unify results from many methods are more robust and more predictive, on the average, than those based on fewer methods, much as the five-prong chair base is more stable than the three-legged chair, which is in turn  more stable than the one-legged chair." (p. 281)
% "Variability causes the need for abstraction. (...) Abstractions are cognitively expensive. They are learned because variability makes them necessary. There is no reason they should be learned in the absence of variability." (p. 292)
% "(...) knowledge of sound structure appears to be spread along a continuum. Fine-grained knowledge of continuous variation tends to lie at the phonetic end. Knowledge of lexical contrasts and alternations tend to be more granular. However, the sources of categoriality cannot be understood if these tendencies are simply assumed as axiomatic in the definitions of the encapsulated models (...)." (p. 287)
...
\epigraphhead[450]{Variability causes the need for abstraction. (...) Abstractions are cognitively expensive. They are learned because variability makes them necessary. There is no reason they should be learned in the absence of variability.\par\hfill\textsc{Pierrehumbert, Beckman and Ladd}}
\part{Full Papers}
{
\include{leonardoanton9}
\include{lauracastilho22}
\include{wellingtonara4}
\include{atosapollosil18}
\include{adelaideherci15}
\include{adrielledecar3}
\include{carlaaparecid31}
\include{adelaideherci14}
\include{zuleicacamarg13}
}


%\epigraphhead[450]{Methodological advances can be just as important as theoretical ones in the progress of science. Established sciences use diverse methods. (...) theories which unify results from many methods are more robust and more predictive, on the average, than those based on fewer methods, much as the five-prong chair base is more stable than the three-legged chair, which is in turn  more stable than the one-legged chair.\par\hfill\textsc{Pierrehumbert, Beckman and Ladd}}
\epigraphhead[450]{The Hidden Harmony is better than the obvious, (...) Opposition brings concord; out of discord comes the fairest harmony. (...) People do not understand how that which is at variance with itself agrees with itself.\par\hfill\textsc{Heraclitus of Ephesus}}
\part{Abstracts}
{
\parindent0pt % disables indentation
\include{marcelomeiraa28}
\include{danielamarali32}
\include{washingtonlui19}
\include{elisabethannb20}
\include{felipefloresk1}
\include{cesartelo33}
\include{mariadefatima7}
\include{mariamendesca21}
\include{melchioraugus10}
\include{matheushenriq12}
\include{matheusfreita6}
\include{franciscoaler5}
}

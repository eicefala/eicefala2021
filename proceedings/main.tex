...
{
%\input{marcelomeiraa28.tex}
%\input{danielamarali32.tex}
\include{leonardoanton9}
\include{lauracastilho22}
\include{wellingtonara4}
\include{atosapollosil18}
%\input{washingtonlui19.tex}
%\input{elisabethannb20.tex}
%\input{felipefloresk1.tex}
}
%
\part{Methods for speech data collection, processing and analysis}
{
%\input{cesartelo33.tex}
\include{adelaideherci15}
%\input{mariadefatima7.tex}
%\input{mariamendesca21.tex}
\include{adrielledecar3}
%\input{melchioraugus10.tex}
...
{
%%\input{adelaideherci14.tex}
%\input{matheushenriq12.tex}
%\input{matheusfreita6.tex}
%\input{franciscoaler5.tex}
